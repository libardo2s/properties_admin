...
class PropertyApiView(APIView):
    ...
    def get(self, request, id=None, format=None):
        try:
            ...
            properties_list = Property.objects.filter(deleted=False)
    ...
    def put(self, request, id=None, format=None):
        try:
            ...
            property_serializer = PropertySerializer(data=request.data)
            if property_serializer.is_valid():
                property.name = property_serializer.get("name", property.name)
                property.address = property_serializer.get("address", property.address)
                property.country = property_serializer.get("country", property.country)
                property.city = property_serializer.get("city", property.city)
                property.zip_code = property_serializer.get(
                    "zip_code", property.zip_code
                )
                property.type = property_serializer.get("type", property.type.id)
                property.area = property_serializer.get("area", property.area)
